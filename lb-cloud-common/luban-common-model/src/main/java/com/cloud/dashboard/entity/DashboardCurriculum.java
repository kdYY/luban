...
@TableName("dashboard_curriculum")
public class DashboardCurriculum extends Model<DashboardCurriculum> implements Serializable {

    private static final long serialVersionUID = 1769429894639712715L;
